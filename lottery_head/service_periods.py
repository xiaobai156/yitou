...
from .selection import describe_conflicting_candidates, extract_period_candidates_by_period, find_latest_available_record, period_boundary_ambiguity, period_value_conflict, position_three_label, select_period_records, select_period_values
    ...
    *,
    ...
    try:
        ...
        if target_conflict:
            ...
            target_error = locked_error_fn(fragments, target_period) or (
